    ...
    <section id="content">
      ...
      <main>
        ...
        <div class="graph-container">
          ...
          <div class="graph">
            <canvas id="forecastChart" width="300" height="300"></canvas>
          </div>
          <div class="graph">
            <canvas id="annualCashFlowChart" width="800" height="400"></canvas>
          </div>
        </div>
      </main>
      <!-- MAIN -->
